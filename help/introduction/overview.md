...
Your solution and other Adobe code libraries must meet [certain requirements](/help/reference/mcvid-requirements.md) before you can use the ID service.
