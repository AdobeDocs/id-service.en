...
* Sets a first-party cookie in customer’s domain to ensure tracking on same domain. See [Experience Cloud](../mcvid-introduction/mcvid-cookies.md). 
