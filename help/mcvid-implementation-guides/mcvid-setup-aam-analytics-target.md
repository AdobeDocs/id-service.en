...
>[!IMPORTANT]
>
>Read the ID service [requirements](../mcvid-reference/mcvid-requirements.md) before you begin and note the following requirements that are specific to this implementation: >
...
* [AMCV cookie](../mcvid-introduction/mcvid-cookies.md) in the domain where you page is hosted. 
...
* You have a [grace period](../mcvid-reference/mcvid-analytics-reference/mcvid-grace-period.md#concept-e4c0d796412b4985badae11e5aecb2fd) enabled.
...
* Remember to disable the grace period once you meet the [criteria for discontinuation](../mcvid-implementation-guides/mcvid-setup-aam-analytics-target.md#section-aceacdb7d5794f25ac6ff46f82e148e1).
