...
description: Documentation for Adobe ECID (Visitor ID Service)
...
| 3 |mid [AMCV_ cookie set by the Visitor ID Service](../introduction/cookies.md) | 5 | Visitor's browser accepts cookies (first-party), and the Visitor ID Service is deployed. |
